...
Rulvar predates Build Week; everything from v1.4.0 through v1.40.0 shipped inside the
submission window (July 13-21, 2026), and the collaboration below is the part of that
work done with Codex.

**Codex was the project's independent QA engineer.** Twenty four times during the week, the
...
The twenty four rounds, verbatim in this repository's history:
