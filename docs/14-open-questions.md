...
| OQ-09 | Phase-3 value-checkpoint quantitative criteria | dogfood telemetry | Closed at M11-T06; rule amended and gate PASSED 2026-07-12: M12 is open |
...
- Rule amended (2026-07-12, founder decision): criterion 2 gains the quality branch, symmetric in spirit to criterion 1's: the criterion holds when the card-informed arm matches or beats the baseline pass rate at no more than 105 percent of its cost, OR beats it by at least 15 points at no more than 115 percent of its cost. The vacuous-pass guard stands unchanged. The amendment applies to FRESH runs only: the 2026-07-11 and 2026-07-12 verdicts above stand as measured under the rule then in force, and one fresh verdict run under the amended rule decides the gate (funded by the remaining second grant).
- Measured under the amended rule (M12-T01 fresh verdict run, 2026-07-12): PASSED; the M12 gate is OPEN. Run 10 (spend $1.59; report: docs/checkpoints/2026-07-12-m12-value-checkpoint-passed.md): criterion 1 HOLDS for the sixth consecutive full run (extraction on both ladders: equal pass rate at a third of the cost; pooled holds); criterion 2 HOLDS with the card-informed arm at 100.0 percent against the baseline's 70.0 percent at 104.8 percent of its cost, which satisfies the ORIGINAL branch as well (match-or-beat under 105 percent), so the verdict does not rest on the quality branch. Per the M12 entry criteria this dated record unlocks M12-T02 through M12-T04; the version is assigned at milestone planning. About $1.5 of the second OQ-28 grant remains.
