...
const assurance = {
  claimConsistency: {
    ...
    coveragePolicy: 'strict-final', // a non-'full' final grade refuses, or is waived by name
  },
} as const;
