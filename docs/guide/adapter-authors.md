...
```json
{
  ...
  "files": ["dist"],
  "sideEffects": false,
  "dependencies": { "@rulvar/core": "^1.30.0" },
  "devDependencies": { "@rulvar/testing": "^1.30.0", "vitest": "^4.1.10" }
}
```
