...
| `error` | absent | absent | absent | Nothing reached the envelope. Read `error.data.source` for which gate refused, and `childrenAtFailure` for what the children had produced. | No |
