...
Defined in: [packages/store-conformance/src/kill-points.ts:881](https://github.com/o-stepper/rulvar/blob/main/packages/store-conformance/src/kill-points.ts#L881)
