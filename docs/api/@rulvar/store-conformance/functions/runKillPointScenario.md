...
Defined in: [packages/store-conformance/src/kill-points.ts:647](https://github.com/o-stepper/rulvar/blob/main/packages/store-conformance/src/kill-points.ts#L647)
