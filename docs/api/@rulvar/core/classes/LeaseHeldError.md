...
Defined in: [packages/core/src/l0/errors.ts:352](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L352)
...
Defined in: [packages/core/src/l0/errors.ts:355](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L355)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-code"></a> `code` | `readonly` | `"lease_held"` | [`RulvarError`](/api/@rulvar/core/classes/RulvarError.md).[`code`](/api/@rulvar/core/classes/RulvarError.md#property-code) | - | [packages/core/src/l0/errors.ts:353](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L353) |
