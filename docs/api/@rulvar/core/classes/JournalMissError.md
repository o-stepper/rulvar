...
Defined in: [packages/core/src/l0/errors.ts:235](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L235)
...
Defined in: [packages/core/src/l0/errors.ts:238](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L238)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-code"></a> `code` | `readonly` | `"journal_miss"` | [`RulvarError`](/api/@rulvar/core/classes/RulvarError.md).[`code`](/api/@rulvar/core/classes/RulvarError.md#property-code) | - | [packages/core/src/l0/errors.ts:236](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L236) |
