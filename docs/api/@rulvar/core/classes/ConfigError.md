...
Defined in: [packages/core/src/l0/errors.ts:86](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L86)
...
Defined in: [packages/core/src/l0/errors.ts:89](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L89)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-code"></a> `code` | `readonly` | `"config"` | [`RulvarError`](/api/@rulvar/core/classes/RulvarError.md).[`code`](/api/@rulvar/core/classes/RulvarError.md#property-code) | - | [packages/core/src/l0/errors.ts:87](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L87) |
