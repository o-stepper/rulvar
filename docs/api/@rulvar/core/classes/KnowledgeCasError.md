...
Defined in: [packages/core/src/l0/errors.ts:443](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L443)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-code"></a> `code` | `readonly` | `"knowledge_cas"` | [`RulvarError`](/api/@rulvar/core/classes/RulvarError.md).[`code`](/api/@rulvar/core/classes/RulvarError.md#property-code) | - | [packages/core/src/l0/errors.ts:444](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L444) |
