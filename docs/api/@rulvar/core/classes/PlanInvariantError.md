...
Defined in: [packages/core/src/l0/errors.ts:205](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L205)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-code"></a> `code` | `readonly` | `"plan_invariant"` | [`RulvarError`](/api/@rulvar/core/classes/RulvarError.md).[`code`](/api/@rulvar/core/classes/RulvarError.md#property-code) | - | [packages/core/src/l0/errors.ts:203](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/errors.ts#L203) |
