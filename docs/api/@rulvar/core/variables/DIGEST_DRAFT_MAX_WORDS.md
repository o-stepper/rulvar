...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / DIGEST\_DRAFT\_MAX\_WORDS

# Variable: DIGEST\_DRAFT\_MAX\_WORDS

```ts
const DIGEST_DRAFT_MAX_WORDS: 400 = 400;
```
