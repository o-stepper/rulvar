...
| <a id="property-state"></a> `state?` | [`AdmissionState`](/api/@rulvar/core/interfaces/AdmissionState.md) | Hydrate from a persisted document (the durable wrappers). | [packages/core/src/admission/memory.ts:75](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/admission/memory.ts#L75) |
