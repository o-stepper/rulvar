...
| ------ | ------ | ------ | ------ |
| <a id="property-args"></a> `args?` | `unknown` | The run's original arguments: not journaled for in-process workflows in v1, so the host supplies them (resume binding residuals). | [packages/core/src/engine/engine.ts:507](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L507) |
| <a id="property-dryrun"></a> `dryRun?` | `boolean` | Dry-run: replay-strict matching; the first would-be-live call throws JournalMissError and the run settles with that typed error, zero live calls performed. | [packages/core/src/engine/engine.ts:513](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L513) |
| <a id="property-invalidate"></a> `invalidate?` | `number`[] | invalidate/retry: entries to unpin before matching. | [packages/core/src/engine/engine.ts:515](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L515) |
...
| `run.budgetUsd?` | `number` | - | [packages/core/src/engine/engine.ts:545](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L545) |
| `run.maxInFlightExposureUsd?` | `number` | - | [packages/core/src/engine/engine.ts:545](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L545) |
