...
Defined in: [packages/core/src/engine/engine.ts:474](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L474)

## Properties

| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="property-args"></a> `args?` | `unknown` | The run's original arguments: not journaled for in-process workflows in v1, so the host supplies them (resume binding residuals). | [packages/core/src/engine/engine.ts:479](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L479) |
| <a id="property-dryrun"></a> `dryRun?` | `boolean` | Dry-run: replay-strict matching; the first would-be-live call throws JournalMissError and the run settles with that typed error, zero live calls performed. | [packages/core/src/engine/engine.ts:485](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L485) |
| <a id="property-invalidate"></a> `invalidate?` | `number`[] | invalidate/retry: entries to unpin before matching. | [packages/core/src/engine/engine.ts:487](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L487) |
...
| `run.budgetUsd?` | `number` | - | [packages/core/src/engine/engine.ts:517](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L517) |
| `run.maxInFlightExposureUsd?` | `number` | - | [packages/core/src/engine/engine.ts:517](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L517) |
