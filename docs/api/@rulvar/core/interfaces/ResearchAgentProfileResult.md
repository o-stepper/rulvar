...
Defined in: [packages/core/src/engine/profile-templates.ts:105](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/profile-templates.ts#L105)
...
- [`ResearchFanOutResult`](/api/@rulvar/core/interfaces/ResearchFanOutResult.md)
