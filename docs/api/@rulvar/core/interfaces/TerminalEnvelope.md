...
| ------ | ------ | ------ | ------ |
| <a id="property-agentsspawned"></a> `agentsSpawned` | `number` | Agents admitted over the run's lifetime, resume seed included. | [packages/core/src/l0/terminal-envelope.ts:64](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/terminal-envelope.ts#L64) |
...
| <a id="property-costbymodel"></a> `costByModel` | `Record`\&lt;`string`, `number`\&gt; | The per-model split of totalUsd, keyed by canonical ModelRef. | [packages/core/src/l0/terminal-envelope.ts:58](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/terminal-envelope.ts#L58) |
...
| <a id="property-usage"></a> `usage` | [`Usage`](/api/@rulvar/core/type-aliases/Usage.md) | The run's usage aggregate, TTL attribution included. | [packages/core/src/l0/terminal-envelope.ts:60](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/terminal-envelope.ts#L60) |
| <a id="property-usageapprox"></a> `usageApprox` | `boolean` | True when any priced usage is approximate: totalUsd is a lower bound. | [packages/core/src/l0/terminal-envelope.ts:62](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/terminal-envelope.ts#L62) |
