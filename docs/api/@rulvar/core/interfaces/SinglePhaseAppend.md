...
Defined in: [packages/core/src/journal/replayer.ts:65](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/journal/replayer.ts#L65)
...
| <a id="property-servedby"></a> `servedBy?` | `` `${string}:${string}` `` | - | - | [packages/core/src/journal/replayer.ts:69](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/journal/replayer.ts#L69) |
...
| <a id="property-status"></a> `status` | `"ok"` | - | - | [packages/core/src/journal/replayer.ts:66](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/journal/replayer.ts#L66) |
| <a id="property-usage"></a> `usage?` | [`Usage`](/api/@rulvar/core/type-aliases/Usage.md) | - | - | [packages/core/src/journal/replayer.ts:68](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/journal/replayer.ts#L68) |
| <a id="property-value"></a> `value?` | `unknown` | - | - | [packages/core/src/journal/replayer.ts:67](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/journal/replayer.ts#L67) |
