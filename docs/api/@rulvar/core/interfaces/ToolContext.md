...
| <a id="property-spanid"></a> `spanId` | `string` | Tool span in the run > phase > agent > tool hierarchy. | [packages/core/src/l0/spi/toolsource.ts:31](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/spi/toolsource.ts#L31) |
