...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / StreamHooks

# Interface: StreamHooks

Defined in: [packages/core/src/l0/spi/provider.ts:29](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/spi/provider.ts#L29)
