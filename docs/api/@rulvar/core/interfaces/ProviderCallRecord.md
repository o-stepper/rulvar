...
| ------ | ------ | ------ | ------ |
| <a id="property-aborted"></a> `aborted?` | `"budget"` \| `"external"` \| `"idle"` | What severed an 'aborted' call. | [packages/core/src/l0/entries.ts:168](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/entries.ts#L168) |
...
| <a id="property-errorcode"></a> `errorCode?` | `string` | WireError.code on 'error' outcomes. | [packages/core/src/l0/entries.ts:166](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/entries.ts#L166) |
