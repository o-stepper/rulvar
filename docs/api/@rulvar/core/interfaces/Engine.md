...
| `stores.journal` | `public` | [`JournalStore`](/api/@rulvar/core/interfaces/JournalStore.md) | - | [packages/core/src/engine/engine.ts:336](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L336) |
| `stores.transcripts` | `public` | [`TranscriptStore`](/api/@rulvar/core/interfaces/TranscriptStore.md) | - | [packages/core/src/engine/engine.ts:336](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L336) |
...
Defined in: [packages/core/src/engine/engine.ts:342](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L342)
...
Defined in: [packages/core/src/engine/engine.ts:326](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L326)
...
Defined in: [packages/core/src/engine/engine.ts:316](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L316)
