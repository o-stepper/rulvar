...
| `stores.journal` | `public` | [`JournalStore`](/api/@rulvar/core/interfaces/JournalStore.md) | - | [packages/core/src/engine/engine.ts:559](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L559) |
| `stores.transcripts` | `public` | [`TranscriptStore`](/api/@rulvar/core/interfaces/TranscriptStore.md) | - | [packages/core/src/engine/engine.ts:559](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L559) |
...
Defined in: [packages/core/src/engine/engine.ts:587](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L587)
...
Defined in: [packages/core/src/engine/engine.ts:539](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L539)
...
Defined in: [packages/core/src/engine/engine.ts:526](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L526)
