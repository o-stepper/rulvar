...
Defined in: [packages/core/src/engine/engine.ts:568](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L568)

## Properties

| Property | Modifier | Type | Description | Defined in |
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-stores"></a> `stores` | `readonly` | \{ `journal`: [`JournalStore`](/api/@rulvar/core/interfaces/JournalStore.md); `transcripts`: [`TranscriptStore`](/api/@rulvar/core/interfaces/TranscriptStore.md); \} | The engine's configured stores, exposed for shells and hosts (M8 entry amendment: the journal store comes from the engine). Exactly the instances createEngine received, or the defaults it built; no store contract widens through this accessor. With a serialization hook configured these are the HOOKED wrappers, so every reader passes the one policy point (M8-T04). | [packages/core/src/engine/engine.ts:604](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L604) |
| `stores.journal` | `public` | [`JournalStore`](/api/@rulvar/core/interfaces/JournalStore.md) | - | [packages/core/src/engine/engine.ts:604](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L604) |
| `stores.transcripts` | `public` | [`TranscriptStore`](/api/@rulvar/core/interfaces/TranscriptStore.md) | - | [packages/core/src/engine/engine.ts:604](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L604) |
...
Defined in: [packages/core/src/engine/engine.ts:614](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L614)
...
Defined in: [packages/core/src/engine/engine.ts:632](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L632)
...
`Promise`\&lt;[`RunExport`](/api/@rulvar/core/interfaces/RunExport.md)\&gt;
...
Defined in: [packages/core/src/engine/engine.ts:652](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L652)
...
Defined in: [packages/core/src/engine/engine.ts:594](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L594)
...
Defined in: [packages/core/src/engine/engine.ts:623](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L623)
...
Defined in: [packages/core/src/engine/engine.ts:584](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L584)
...
unless [ResumeOptions.bodyHash](/api/@rulvar/core/interfaces/ResumeOptions.md#property-bodyhash) is 'refuse', which makes it
...
Defined in: [packages/core/src/engine/engine.ts:569](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L569)
