...
| <a id="property-escalation"></a> `escalation?` | [`EscalationOptions`](/api/@rulvar/core/interfaces/EscalationOptions.md) | Flavor B opt-in lives here or on the call (docs/07, section 6). | [packages/core/src/engine/ctx.ts:129](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/ctx.ts#L129) |
...
| <a id="property-isolation"></a> `isolation?` | [`IsolationSpec`](/api/@rulvar/core/type-aliases/IsolationSpec.md) | Isolation default; the RESOLVED value enters identity (docs/08). | [packages/core/src/engine/ctx.ts:127](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/ctx.ts#L127) |
...
| <a id="property-permissions"></a> `permissions?` | [`AgentProfilePermissions`](/api/@rulvar/core/interfaces/AgentProfilePermissions.md) | Chain layers merged over engine defaults (docs/08, section 3.7). | [packages/core/src/engine/ctx.ts:125](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/ctx.ts#L125) |
