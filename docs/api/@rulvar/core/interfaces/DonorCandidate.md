...
| <a id="property-preabandonstatus"></a> `preAbandonStatus` | `"error"` \| `"limit"` \| `"ok"` \| `"cancelled"` \| `"running"` \| `"escalated"` | Effective root status BEFORE the abandon overlay. | [packages/core/src/journal/reuse.ts:135](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/journal/reuse.ts#L135) |
