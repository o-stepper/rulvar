...
Defined in: [packages/core/src/engine/engine.ts:931](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L931)
...
| ------ | ------ | ------ |
| <a id="property-normalize"></a> `normalize?` | [`ScopeNormalizeTable`](/api/@rulvar/core/interfaces/ScopeNormalizeTable.md) | [packages/core/src/engine/engine.ts:933](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L933) |
| <a id="property-unknown"></a> `unknown?` | `"reject"` \| `"drop"` | [packages/core/src/engine/engine.ts:932](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L932) |
