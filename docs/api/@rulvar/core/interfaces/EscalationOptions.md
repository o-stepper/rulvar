...
| <a id="property-minspendusd"></a> `minSpendUsd?` | `number` | In-run minimum spend before scope_bigger; default 0 (M3-T09). A finite number >= 0, validated before any LLM call: the gate compares spend against it, and a NaN would silently disable it. | [packages/core/src/runtime/escalation.ts:66](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/runtime/escalation.ts#L66) |
