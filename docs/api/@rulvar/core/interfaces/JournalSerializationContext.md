...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / JournalSerializationContext
...
| ------ | ------ | ------ |
| <a id="property-runid"></a> `runId` | `string` | [packages/core/src/l0/serialization.ts:38](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/serialization.ts#L38) |
