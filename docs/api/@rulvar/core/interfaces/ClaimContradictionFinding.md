...
Defined in: [packages/core/src/orchestrator/orchestrate.ts:1163](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/orchestrate.ts#L1163)
...
| <a id="property-reason"></a> `reason` | `string` | - | - | [packages/core/src/orchestrator/orchestrate.ts:1164](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/orchestrate.ts#L1164) |
