...
Defined in: [packages/core/src/orchestrator/orchestrate.ts:837](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/orchestrate.ts#L837)
...
| <a id="property-reason"></a> `reason` | `string` | - | - | [packages/core/src/orchestrator/orchestrate.ts:838](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/orchestrate.ts#L838) |
