...
Defined in: [packages/core/src/orchestrator/orchestrate.ts:872](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/orchestrate.ts#L872)
...
| <a id="property-reason"></a> `reason` | `string` | - | - | [packages/core/src/orchestrator/orchestrate.ts:873](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/orchestrate.ts#L873) |
