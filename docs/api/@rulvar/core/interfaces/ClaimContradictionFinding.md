...
Defined in: [packages/core/src/orchestrator/orchestrate.ts:913](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/orchestrate.ts#L913)
...
| <a id="property-reason"></a> `reason` | `string` | - | - | [packages/core/src/orchestrator/orchestrate.ts:914](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/orchestrate.ts#L914) |
