...
| <a id="property-postfanin"></a> `postFanIn?` | [`JournaledPostFanIn`](/api/@rulvar/core/interfaces/JournaledPostFanIn.md) | The window itemization a journal CAN answer (RV3404); present exactly when `postFanInMs` is. | [packages/core/src/stores/critical-path.ts:99](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/stores/critical-path.ts#L99) |
