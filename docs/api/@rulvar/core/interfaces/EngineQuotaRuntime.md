...
| <a id="property-tenantfrom"></a> `tenantFrom?` | `"engine"` \| `"scope"` | Where the reservation tenant comes from (RV4205); absent reads 'engine'. | [packages/core/src/model/quota.ts:600](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/model/quota.ts#L600) |
