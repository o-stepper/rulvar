...
Defined in: [packages/core/src/engine/engine.ts:138](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L138)

## Properties

| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="property-adapters"></a> `adapters` | [`ProviderAdapter`](/api/@rulvar/core/interfaces/ProviderAdapter.md)[] | - | [packages/core/src/engine/engine.ts:139](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L139) |
| <a id="property-budgetdefaults"></a> `budgetDefaults?` | [`BudgetDefaults`](/api/@rulvar/core/interfaces/BudgetDefaults.md) | - | [packages/core/src/engine/engine.ts:152](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L152) |
| <a id="property-concurrency"></a> `concurrency?` | \{ `perProvider?`: `Record`\&lt;`string`, `number`\&gt;; `perRun?`: `number`; \} | - | [packages/core/src/engine/engine.ts:153](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L153) |
| `concurrency.perProvider?` | `Record`\&lt;`string`, `number`\&gt; | Per-adapter-id caps; unlimited unless configured (Appendix A; M4-T07). | [packages/core/src/engine/engine.ts:156](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L156) |
| `concurrency.perRun?` | `number` | - | [packages/core/src/engine/engine.ts:154](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L154) |
| <a id="property-defaults"></a> `defaults?` | [`EngineDefaults`](/api/@rulvar/core/interfaces/EngineDefaults.md) | - | [packages/core/src/engine/engine.ts:151](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L151) |
...
| <a id="property-pricing"></a> `pricing?` | [`PriceTable`](/api/@rulvar/core/interfaces/PriceTable.md) | Versioned price table; wins over caps.pricing (M4-T06). | [packages/core/src/engine/engine.ts:159](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L159) |
| <a id="property-redaction"></a> `redaction?` | \{ `maskEvents?`: `boolean`; \} | The default key-masking policy at the telemetry boundary. Default ON: key-shaped strings in every emitted WorkflowEvent are masked; never touches the journal. | [packages/core/src/engine/engine.ts:194](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L194) |
| `redaction.maskEvents?` | `boolean` | - | [packages/core/src/engine/engine.ts:194](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L194) |
...
| `runners.sandbox?` | [`ScriptRunner`](/api/@rulvar/core/interfaces/ScriptRunner.md) | - | [packages/core/src/engine/engine.ts:166](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L166) |
...
| <a id="property-stores"></a> `stores?` | \{ `journal?`: [`JournalStore`](/api/@rulvar/core/interfaces/JournalStore.md); `modelKnowledge?`: [`ModelKnowledgeStore`](/api/@rulvar/core/interfaces/ModelKnowledgeStore.md); `transcripts?`: [`TranscriptStore`](/api/@rulvar/core/interfaces/TranscriptStore.md); \} | - | [packages/core/src/engine/engine.ts:140](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L140) |
| `stores.journal?` | [`JournalStore`](/api/@rulvar/core/interfaces/JournalStore.md) | Default InMemoryStore (resume disabled, loud warning). | [packages/core/src/engine/engine.ts:142](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L142) |
...
| `stores.transcripts?` | [`TranscriptStore`](/api/@rulvar/core/interfaces/TranscriptStore.md) | - | [packages/core/src/engine/engine.ts:143](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/engine.ts#L143) |
