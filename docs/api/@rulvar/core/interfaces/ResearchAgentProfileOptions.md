...
| <a id="property-evidencecontract"></a> `evidenceContract?` | [`EvidenceContract`](/api/@rulvar/core/interfaces/EvidenceContract.md) | The declared evidence floor of the task (RV303), passed through to [AgentProfile.evidenceContract](/api/@rulvar/core/interfaces/AgentProfile.md#property-evidencecontract) so preflight can compare it against the profile's tool budget and warn `tool-cap-below-evidence-floor` before any paid call. | - | [packages/core/src/engine/profile-templates.ts:98](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/profile-templates.ts#L98) |
