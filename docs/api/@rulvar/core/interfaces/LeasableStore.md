...
Defined in: [packages/core/src/l0/spi/store.ts:294](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/spi/store.ts#L294)
...
- [`EffectLaneStore`](/api/@rulvar/core/interfaces/EffectLaneStore.md)
