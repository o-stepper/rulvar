...
| <a id="property-isolation"></a> `isolation` | [`IsolationSpec`](/api/@rulvar/core/type-aliases/IsolationSpec.md) | Canonical encoding per docs/08, section "IsolationSpec". | [packages/core/src/journal/identity.ts:32](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/journal/identity.ts#L32) |
