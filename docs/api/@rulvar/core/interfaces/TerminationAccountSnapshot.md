...
| <a id="property-phi"></a> `phi` | `number` | The variant function, a pure fold over the journal (docs/07, 11.4). | [packages/core/src/journal/termination.ts:67](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/journal/termination.ts#L67) |
