...
| <a id="property-expiresat"></a> `expiresAt` | `string` | TTL by class and polarity (docs/05, section "Grounding and decay"). | [packages/core/src/l0/spi/knowledge.ts:68](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/spi/knowledge.ts#L68) |
