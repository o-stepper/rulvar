...
Defined in: [packages/core/src/engine/persisted-terminal.ts:62](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/persisted-terminal.ts#L62)
