...
Defined in: [packages/core/src/runtime/permission-chain.ts:25](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/runtime/permission-chain.ts#L25)
