...
| `salvagedTerminalOutputChildren?` | `string`[] | Children accepted through validated terminal output salvage on 'limit'; same lift. | [packages/core/src/l0/events.ts:101](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/events.ts#L101) |
