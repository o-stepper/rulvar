...
[rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / HashVersion
...
Defined in: [packages/core/src/l0/entries.ts:18](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/entries.ts#L18)
