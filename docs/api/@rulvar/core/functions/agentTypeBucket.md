...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / agentTypeBucket
...
Defined in: [packages/core/src/engine/cost-report.ts:89](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/engine/cost-report.ts#L89)
...
ONE [synthesizeSpanClassOf](/api/@rulvar/core/functions/synthesizeSpanClassOf.md) classifier: 'synthesizer' for
