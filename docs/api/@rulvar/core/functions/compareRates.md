...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / compareRates
...
Defined in: [packages/core/src/model/pricing.ts:206](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/model/pricing.ts#L206)
...
| Parameter | Type |
| ------ | ------ |
| `seed` | [`DocumentedRates`](/api/@rulvar/core/interfaces/DocumentedRates.md) |
| `page` | [`DocumentedRates`](/api/@rulvar/core/interfaces/DocumentedRates.md) |
