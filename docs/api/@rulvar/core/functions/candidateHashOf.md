...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / candidateHashOf
...
Defined in: [packages/core/src/stores/synthesis-candidates.ts:46](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/stores/synthesis-candidates.ts#L46)
