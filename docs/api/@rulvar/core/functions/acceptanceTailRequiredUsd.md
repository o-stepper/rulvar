...
Defined in: [packages/core/src/orchestrator/admission.ts:432](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/admission.ts#L432)
...
| ------ | ------ | ------ |
| `requiredUsd` | `number` | [packages/core/src/orchestrator/admission.ts:433](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/admission.ts#L433) |
| `terms` | [`AcceptanceTailTerms`](/api/@rulvar/core/interfaces/AcceptanceTailTerms.md) | [packages/core/src/orchestrator/admission.ts:434](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/admission.ts#L434) |
