...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / classifyEvidenceFile
...
Defined in: [packages/core/src/runtime/evidence-categories.ts:28](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/runtime/evidence-categories.ts#L28)
...
[`EvidenceCategory`](/api/@rulvar/core/type-aliases/EvidenceCategory.md)
