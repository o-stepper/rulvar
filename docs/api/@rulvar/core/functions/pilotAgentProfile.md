...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / pilotAgentProfile
...
assembly. Builds on [researchAgentProfile](/api/@rulvar/core/functions/researchAgentProfile.md) (the confined
...
`Promise`\&lt;[`PilotAgentProfileResult`](/api/@rulvar/core/interfaces/PilotAgentProfileResult.md)\&gt;
