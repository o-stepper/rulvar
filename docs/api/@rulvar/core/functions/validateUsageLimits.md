...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / validateUsageLimits
...
Defined in: [packages/core/src/runtime/usage-limits.ts:164](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/runtime/usage-limits.ts#L164)
...
| Parameter | Type |
| ------ | ------ |
| `limits` | [`UsageLimits`](/api/@rulvar/core/interfaces/UsageLimits.md) |
| `site` | `string` |
