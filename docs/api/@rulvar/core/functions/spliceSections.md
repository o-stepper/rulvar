...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / spliceSections
...
Defined in: [packages/core/src/orchestrator/finish-validators.ts:268](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/finish-validators.ts#L268)
...
is line anchored on purpose (the [SectionMatchMode](/api/@rulvar/core/type-aliases/SectionMatchMode.md) 'line'
