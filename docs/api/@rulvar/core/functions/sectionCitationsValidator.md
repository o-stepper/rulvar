...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / sectionCitationsValidator
...
Defined in: [packages/core/src/orchestrator/finish-validators.ts:1024](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/finish-validators.ts#L1024)
