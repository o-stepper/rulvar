...
Defined in: [packages/core/src/runtime/structured-output.ts:22](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/runtime/structured-output.ts#L22)
