...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / quotaRuleAdmission
...
Defined in: [packages/core/src/model/quota.ts:123](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/model/quota.ts#L123)
...
| `counters` | [`QuotaCounters`](/api/@rulvar/core/interfaces/QuotaCounters.md) |
| `estimate` | [`QuotaCounters`](/api/@rulvar/core/interfaces/QuotaCounters.md) |
