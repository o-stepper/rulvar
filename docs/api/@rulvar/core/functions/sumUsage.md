...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / sumUsage
...
Defined in: [packages/core/src/l0/usage.ts:147](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/l0/usage.ts#L147)
...
| Parameter | Type |
| ------ | ------ |
| `total` | [`Usage`](/api/@rulvar/core/type-aliases/Usage.md) |
| `turn` | [`Usage`](/api/@rulvar/core/type-aliases/Usage.md) |
