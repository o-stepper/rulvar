...
[Rulvar API reference](/api/index.md) / [@rulvar/core](/api/@rulvar/core/index.md) / effectLaneAdmissible
...
Defined in: [packages/core/src/effects/admissible.ts:44](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/effects/admissible.ts#L44)
...
| Parameter | Type |
| ------ | ------ |
| `envelope` | [`TerminalEnvelope`](/api/@rulvar/core/interfaces/TerminalEnvelope.md) |

## Returns

[`EffectLaneAdmissionVerdict`](/api/@rulvar/core/type-aliases/EffectLaneAdmissionVerdict.md)
