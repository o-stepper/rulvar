...
Defined in: [packages/core/src/orchestrator/citation-audit.ts:429](https://github.com/o-stepper/rulvar/blob/main/packages/core/src/orchestrator/citation-audit.ts#L429)
...
window. The unit rules, all bounded by [MAX\_CITATION\_EXCERPT\_LINES](/api/@rulvar/core/variables/MAX_CITATION_EXCERPT_LINES.md) and [MAX\_CITATION\_EXCERPT\_CHARS](/api/@rulvar/core/variables/MAX_CITATION_EXCERPT_CHARS.md)
