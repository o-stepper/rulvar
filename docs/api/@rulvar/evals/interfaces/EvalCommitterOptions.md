...
| ------ | ------ | ------ | ------ |
| <a id="property-attempts"></a> `attempts?` | `number` | CAS-rebase attempts (docs/05, 5.4); default 3. | [packages/evals/src/committer.ts:48](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/committer.ts#L48) |
