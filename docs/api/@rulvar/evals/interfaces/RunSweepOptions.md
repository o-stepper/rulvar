...
| <a id="property-store"></a> `store?` | [`ModelKnowledgeStore`](/api/@rulvar/rulvar/interfaces/ModelKnowledgeStore.md) | When given, emitted claims commit through the committer identity. | [packages/evals/src/sweeps.ts:81](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/sweeps.ts#L81) |
