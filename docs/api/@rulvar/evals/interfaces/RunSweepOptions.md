...
| ------ | ------ | ------ | ------ |
| <a id="property-committerid"></a> `committerId` | `string` | The dedicated identity (docs/05, 5.4). | [packages/evals/src/sweeps.ts:53](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/sweeps.ts#L53) |
...
| <a id="property-store"></a> `store?` | [`ModelKnowledgeStore`](/api/@rulvar/rulvar/interfaces/ModelKnowledgeStore.md) | When given, emitted claims commit through the committer identity. | [packages/evals/src/sweeps.ts:67](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/sweeps.ts#L67) |
