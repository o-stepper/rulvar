...
| <a id="property-model"></a> `model` | [`ModelSpec`](/api/@rulvar/rulvar/type-aliases/ModelSpec.md) | Judge model; required, never defaulted (docs/04 role quality floors). | [packages/evals/src/graders/judge.ts:28](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/graders/judge.ts#L28) |
