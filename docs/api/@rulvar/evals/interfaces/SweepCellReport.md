...
| <a id="property-incompletereason"></a> `incompleteReason?` | `"judge-exhausted"` \| `"judge-refused"` \| `"envelope-exhausted"` | Why the cell is incomplete, when it is. | [packages/evals/src/sweeps.ts:142](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/sweeps.ts#L142) |
...
| <a id="property-refusedrunlabel"></a> `refusedRunLabel?` | `string` | The refused run's label, when the envelope refused one. | [packages/evals/src/sweeps.ts:144](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/sweeps.ts#L144) |
