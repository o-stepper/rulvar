...
| <a id="property-latencyms"></a> `latencyMs` | `number` | run:start to run:end of the target run, from event timestamps; no separate measurement channel exists. | [packages/evals/src/case.ts:96](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/case.ts#L96) |
