...
Defined in: [packages/evals/src/canary.ts:39](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/canary.ts#L39)

## Properties

| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="property-budgetusd"></a> `budgetUsd?` | `number` | Immutable ceiling per probe run (v1.16.2 review P1-2): every probe is an ordinary paid engine run and gets its own recorded RunMeta.budgetUsd. | [packages/evals/src/canary.ts:45](https://github.com/o-stepper/rulvar/blob/main/packages/evals/src/canary.ts#L45) |
