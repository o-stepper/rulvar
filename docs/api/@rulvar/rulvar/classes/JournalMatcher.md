...
[Rulvar API reference](/api/index.md) / [@rulvar/rulvar](/api/@rulvar/rulvar/index.md) / JournalMatcher
...
| `options?` | \{ `disposition?`: (`op`) => [`OperationDisposition`](/api/@rulvar/rulvar/type-aliases/OperationDisposition.md); `keyRing?`: [`KeyRing`](/api/@rulvar/rulvar/interfaces/KeyRing.md); \} |
