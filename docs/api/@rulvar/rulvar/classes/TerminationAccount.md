...
[Rulvar API reference](/api/index.md) / [@rulvar/rulvar](/api/@rulvar/rulvar/index.md) / TerminationAccount
...
| Parameter | Type |
| ------ | ------ |
| `options` | \{ `deniedWriter?`: [`TerminationDeniedWriter`](/api/@rulvar/rulvar/type-aliases/TerminationDeniedWriter.md); `limits`: [`TerminationLimits`](/api/@rulvar/rulvar/interfaces/TerminationLimits.md); \} |
| `options.deniedWriter?` | [`TerminationDeniedWriter`](/api/@rulvar/rulvar/type-aliases/TerminationDeniedWriter.md) |
| `options.limits` | [`TerminationLimits`](/api/@rulvar/rulvar/interfaces/TerminationLimits.md) |
...
| Parameter | Type |
| ------ | ------ |
| `writer` | [`TerminationDeniedWriter`](/api/@rulvar/rulvar/type-aliases/TerminationDeniedWriter.md) |
...
`Promise`\&lt;[`DebitResult`](/api/@rulvar/rulvar/type-aliases/DebitResult.md)\&gt;
...
| ------ | ------ |
| `logicalTaskId` | `string` |
| `state` | [`LineageCounters`](/api/@rulvar/rulvar/interfaces/LineageCounters.md) & \{ `rungIndex?`: `number`; \} |
