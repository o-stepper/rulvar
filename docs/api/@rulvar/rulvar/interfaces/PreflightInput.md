...
| <a id="property-run"></a> `run?` | `Pick`\&lt;[`RunOptions`](/api/@rulvar/rulvar/interfaces/RunOptions.md), `"budgetUsd"` \| `"limits"` \| `"maxInFlightExposureUsd"`\&gt; | The RunOptions slice: the ceiling, run-level limits, and the RV711 exposure cap. | `packages/core/dist/index.d.ts` |
