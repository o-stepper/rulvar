...
| <a id="property-kind"></a> `kind` | `readonly` | `"compiled-workflow"` | [packages/core/dist/index.d.ts](https://github.com/o-stepper/rulvar/blob/main/../../core/dist/index.d.ts) |
...
| <a id="property-source"></a> `source` | `readonly` | `string` | [packages/core/dist/index.d.ts](https://github.com/o-stepper/rulvar/blob/main/../../core/dist/index.d.ts) |
