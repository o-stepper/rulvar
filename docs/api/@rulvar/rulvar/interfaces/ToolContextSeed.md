...
| <a id="property-cwd"></a> `cwd` | `string` | Isolation working directory; the host cwd under isolation 'none'. | [packages/core/dist/index.d.ts](https://github.com/o-stepper/rulvar/blob/main/../../core/dist/index.d.ts) |
