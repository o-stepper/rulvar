...
| <a id="property-buckets"></a> `buckets` | `Record`\&lt;`string`, \{ `bucket?`: [`TokenBucketState`](/api/@rulvar/rulvar/interfaces/TokenBucketState.md); `debts`: \{ `atMs`: `number`; `wires`: `number`; \}[]; `held`: `number`; `parked?`: `number`; `window?`: [`SlidingWindowState`](/api/@rulvar/rulvar/interfaces/SlidingWindowState.md); \}\&gt; | `packages/core/dist/index.d.ts` |
