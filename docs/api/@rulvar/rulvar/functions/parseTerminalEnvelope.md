...
[Rulvar API reference](/api/index.md) / [@rulvar/rulvar](/api/@rulvar/rulvar/index.md) / parseTerminalEnvelope
...
[ConfigError](/api/@rulvar/rulvar/classes/ConfigError.md) naming the field and the defect: enum `status`
