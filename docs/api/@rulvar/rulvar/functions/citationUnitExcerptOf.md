...
window. The unit rules, all bounded by [MAX\_CITATION\_EXCERPT\_LINES](/api/@rulvar/rulvar/variables/MAX_CITATION_EXCERPT_LINES.md) and [MAX\_CITATION\_EXCERPT\_CHARS](/api/@rulvar/rulvar/variables/MAX_CITATION_EXCERPT_CHARS.md)
