...
([TERMINAL\_TELEMETRY\_SCOPE](/api/@rulvar/rulvar/variables/TERMINAL_TELEMETRY_SCOPE.md) names them) can be read against the
...
[`LogicalRunTelemetry`](/api/@rulvar/rulvar/interfaces/LogicalRunTelemetry.md)
