...
[Rulvar API reference](/api/index.md) / [@rulvar/rulvar](/api/@rulvar/rulvar/index.md) / acceptanceTailRequiredUsd
...
[dispatchProjectionReserveUsd](/api/@rulvar/rulvar/functions/dispatchProjectionReserveUsd.md) precedent: one formula, so the
...
| Parameter | Type |
| ------ | ------ |
| `spec` | [`AcceptanceTailSpec`](/api/@rulvar/rulvar/interfaces/AcceptanceTailSpec.md) |
...
| ------ | ------ | ------ |
| `requiredUsd` | `number` | `packages/core/dist/index.d.ts` |
| `terms` | [`AcceptanceTailTerms`](/api/@rulvar/rulvar/interfaces/AcceptanceTailTerms.md) | `packages/core/dist/index.d.ts` |
