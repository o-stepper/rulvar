...
[Rulvar API reference](/api/index.md) / [@rulvar/rulvar](/api/@rulvar/rulvar/index.md) / statementRowsFromDelimited
...
hands a host) into the header-keyed rows [statementFromRows](/api/@rulvar/rulvar/functions/statementFromRows.md)
...
a downloaded export and [reconcileStatement](/api/@rulvar/rulvar/functions/reconcileStatement.md).
...
| ------ | ------ |
| `text` | `string` |
| `options?` | [`DelimitedStatementOptions`](/api/@rulvar/rulvar/interfaces/DelimitedStatementOptions.md) |
