...
[Rulvar API reference](/api/index.md) / [@rulvar/rulvar](/api/@rulvar/rulvar/index.md) / pairDraftClaims
...
| `options?` | [`ClaimPairOptions`](/api/@rulvar/rulvar/interfaces/ClaimPairOptions.md) |

## Returns

[`ClaimPairsFold`](/api/@rulvar/rulvar/interfaces/ClaimPairsFold.md)
