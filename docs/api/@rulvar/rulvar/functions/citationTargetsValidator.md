...
[citedValueValidator](/api/@rulvar/rulvar/functions/citedValueValidator.md) resolves a citation only when its
...
`resolve` is the same host contract [citedValueValidator](/api/@rulvar/rulvar/functions/citedValueValidator.md)
