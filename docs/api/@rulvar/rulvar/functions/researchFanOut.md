...
[Rulvar API reference](/api/index.md) / [@rulvar/rulvar](/api/@rulvar/rulvar/index.md) / researchFanOut

# Function: researchFanOut()

```ts
function researchFanOut(options): ResearchFanOutResult;
```
...
[RESEARCH\_FAN\_OUT\_LIMITS](/api/@rulvar/rulvar/variables/RESEARCH_FAN_OUT_LIMITS.md) merged under the caller's `limits`,
...
| Parameter | Type |
| ------ | ------ |
| `options` | [`ResearchFanOutOptions`](/api/@rulvar/rulvar/interfaces/ResearchFanOutOptions.md) |
