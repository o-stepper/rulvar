...
| [anthropic](/api/@rulvar/rulvar/functions/anthropic.md) | Creates the first-class Anthropic adapter (id 'anthropic'). SDK autoretries are disabled (max_retries 0): the core owns retries and wall-clock. |
