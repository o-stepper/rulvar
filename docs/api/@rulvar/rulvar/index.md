...
| [modelKnowledgeCard](/api/@rulvar/rulvar/functions/modelKnowledgeCard.md) | The deterministic card render. Pure: same filtered claims and ladders give byte-identical text. The render budget is 4096 chars; over it, the OLDEST-observed notes withhold first behind an explicit marker. |
