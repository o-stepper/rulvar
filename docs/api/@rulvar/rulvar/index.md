...
| [resolveToolset](/api/@rulvar/rulvar/functions/resolveToolset.md) | Expands sources, validates every tool name and duplicate names across the whole toolset (ConfigError at spawn time), and computes the toolsetHash over contracts sorted by name. |
