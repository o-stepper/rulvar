...
[rulvar API reference](/api/index.md) / [@rulvar/plan](/api/@rulvar/plan/index.md) / chainEffortOf

# Function: chainEffortOf()
...
[`Effort`](/api/@rulvar/rulvar/type-aliases/Effort.md) \| `undefined`
