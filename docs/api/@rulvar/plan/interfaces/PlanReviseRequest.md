...
| ------ | ------ | ------ | ------ |
| <a id="property-base"></a> `base` | [`PlanSnapshotRef`](/api/@rulvar/plan/interfaces/PlanSnapshotRef.md) | Mandatory; the call is rejected without it. | [packages/plan/src/plan-entries.ts:123](https://github.com/o-stepper/rulvar/blob/main/packages/plan/src/plan-entries.ts#L123) |
