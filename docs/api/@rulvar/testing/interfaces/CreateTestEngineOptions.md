...
| <a id="property-executors"></a> `executors?` | `Partial`\&lt;`Record`\&lt;[`IsolatedExecutorTag`](/api/@rulvar/rulvar/type-aliases/IsolatedExecutorTag.md), [`ToolExecutorProvider`](/api/@rulvar/rulvar/interfaces/ToolExecutorProvider.md)\&gt;\&gt; | Isolated tool executors, as in production (RV-216). | [packages/testing/src/test-engine.ts:44](https://github.com/o-stepper/rulvar/blob/main/packages/testing/src/test-engine.ts#L44) |
| <a id="property-pricing"></a> `pricing?` | [`PriceTable`](/api/@rulvar/rulvar/interfaces/PriceTable.md) | Versioned price table; wins over adapter caps.pricing, as in production. | [packages/testing/src/test-engine.ts:46](https://github.com/o-stepper/rulvar/blob/main/packages/testing/src/test-engine.ts#L46) |
...
| <a id="property-quota"></a> `quota?` | [`EngineQuotaConfig`](/api/@rulvar/rulvar/interfaces/EngineQuotaConfig.md) | The shared quota limiter config, as in production (RV-215). | [packages/testing/src/test-engine.ts:42](https://github.com/o-stepper/rulvar/blob/main/packages/testing/src/test-engine.ts#L42) |
