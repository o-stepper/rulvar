...
| <a id="property-pricing"></a> `pricing?` | [`PriceTable`](/api/@rulvar/rulvar/interfaces/PriceTable.md) | Versioned price table; wins over adapter caps.pricing, as in production. | [packages/testing/src/test-engine.ts:42](https://github.com/o-stepper/rulvar/blob/main/packages/testing/src/test-engine.ts#L42) |
