...
| <a id="property-priceusd"></a> `priceUsd` | (`servedBy`, `usage`) => `number` \| `undefined` | The journal-fold price function (table wins over caps). | [packages/cli/src/engine-assembly.ts:37](https://github.com/o-stepper/rulvar/blob/main/packages/cli/src/engine-assembly.ts#L37) |
