...
|---|---|---|
| The fixed group (fifteen packages) | <!-- version:lockstep -->1.213.0<!-- /version --> | Lockstep: identical versions, released together |
...
[`@rulvar/compat`](/api/@rulvar/compat/) is the only package outside lockstep, and its version (<!-- version:compat -->0.1.1<!-- /version --> today, while the group is at <!-- version:lockstep -->1.213.0<!-- /version -->) is not a mistake.
