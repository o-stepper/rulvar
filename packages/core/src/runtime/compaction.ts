 ...
 * per-profile contextWindow threshold (default 0.8)
 ...
 *
 * Owning contract: https://docs.rulvar.com/guide/agents (M4-T03
 * committed semantics; summarize is an invocation role of the router).
 */
