...
export function toJsonDiagnostics(messages: readonly Linter.LintMessage[]): LurkerLintDiagnostic[] {
  return messages.map((message) => {
    const diagnostic: LurkerLintDiagnostic = {
